...
interface SendGDriveReportToServerDialog {
...
const SendQAReportDialog: React.FC<SendGDriveReportToServerDialog> = ({ gDriveUploadData, setGDriveUploadData, snackBarMsg, setSnackBarMsg, password }) => {
    ...
    return (
        <div>
            <Button variant="contained" onClick={handleClickOpen} disabled={AllGDriveUploadLinkReportStats.isEmpty(gDriveUploadData)}>
